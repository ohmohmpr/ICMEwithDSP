...
class SensorDataloader:
    ...
    def __post_init__(self) -> None:
        ...
        if self.cam_names:
            sequence = self.dataset_dir.parts[-1]
            synchronization_cache_path = HOME / ".cache" / "av2" / sequence /  "synchronization_cache.feather"
    ...
    def _build_sensor_cache(self) -> pd.DataFrame:
        ...
        sequence = self.dataset_dir.parts[-1]
        sensor_cache_path = HOME / ".cache" / "av2" / sequence / "sensor_cache.feather"
